...
$qry_INSERT="INSERT INTO `user_ratings`(`member_id`, `Dishes_ID`, `rating`) VALUES ('$one',$two,3)";
$qry_UPDATE="update user_ratings set rating=rating+3 where Dishes_ID=$two AND member_id='$one'";
